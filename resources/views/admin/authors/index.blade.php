    ...
    <div class="px-4 sm:px-0">
        <div class="admin-hero">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="admin-hero-title">{{ __('admin.authors.page_title') }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="admin-vstat grad-indigo">
                ...
                <div class="min-w-0">
                    <dl>
                        <dt class="admin-vstat-label">{{ __('admin.authors.stats_total') }}</dt>
                        <dd class="admin-vstat-value">{{ (int) ($stats['total_authors'] ?? 0) }}</dd>
                    </dl>
                </div>
            </div>
            <div class="admin-vstat grad-emerald">
                <span class="admin-vstat-icon"><i data-lucide="user-check" class="h-6 w-6"></i></span>
                <div class="min-w-0">
                    <dl>
                        <dt class="admin-vstat-label">{{ __('admin.authors.stats_active') }}</dt>
                        <dd class="admin-vstat-value">{{ (int) ($stats['active_authors'] ?? 0) }}</dd>
                    </dl>
                </div>
            </div>
            <div class="admin-vstat grad-amber">
                ...
                <div class="min-w-0">
                    <dl>
                        <dt class="admin-vstat-label">{{ __('admin.authors.stats_average') }}</dt>
                        <dd class="admin-vstat-value">{{ (float) ($stats['avg_articles'] ?? 0) }}</dd>
                    </dl>
                </div>
            </div>
        </div>
