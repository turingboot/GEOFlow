    ...
    <div class="px-4 sm:px-0">
        <div class="admin-hero">
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.image-libraries.index') }}" class="text-white/70 hover:text-white">
                    <i data-lucide="arrow-left" class="w-5 h-5"></i>
                </a>
                <div>
                    <h1 class="admin-hero-title">{{ $library->name }}</h1>
                    <p class="admin-hero-sub">{{ $library->description !== '' ? $library->description : __('admin.common.none_desc') }}</p>
                </div>
            </div>
            <div class="admin-hero-actions">
                ...
                <button type="button" onclick="showUploadModal()" class="admin-btn admin-btn-primary">
