    ...
    <div class="space-y-8 px-4 sm:px-0">
        <div class="admin-hero">
            ...
            <div class="admin-hero-actions">
                <button type="button" data-selected-sync-open class="admin-btn admin-btn-secondary">
                    <i data-lucide="list-checks" class="h-4 w-4"></i>
                    {{ __('admin.distribution.button.sync_settings_selected') }}
                </button>
                <a href="{{ route('admin.distribution.sync-settings-all.preview') }}" class="admin-btn admin-btn-secondary">
